        ...
        <div class="">
            <div class="card-box">
                <table id="datatable" class="table table-hover m-0 table-actions-bar dt-responsive dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="<?=site_url("asset/images/icons/folder.svg")?>" alt="folder" height="35px" /></td>
                            <td>ฝ่าย IT</td>
                            <td></td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
                        ...
                        <tr>
                            <td><img src="<?= site_url("asset/images/file_icons/png.svg") ?>" alt="png" height="35px" ></td>
                            <td>รูปภาพ</td>
                            <td>521 KB</td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
                        ...
                        <tr>
                            <td><img src="<?= site_url("asset/images/file_icons/jpg.svg") ?>" alt="jpg" height="35px" ></td>
                            <td>รูปภาพ</td>
                            <td>521 KB</td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
                        ...
                        <tr>
                            <td><img src="<?= site_url("asset/images/file_icons/ppt.svg") ?>" alt="ppt" height="35px" ></td>
                            <td>พรีเซ้นท์</td>
                            <td>521 KB</td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
                        ...
                        <tr>
                            <td><img src="<?= site_url("asset/images/file_icons/pdf.svg") ?>" alt="pdf" height="35px" ></td>
                            <td>เอกสาร</td>
                            <td>521 KB</td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
                        ...
                        <tr>
                            <td><img src="<?= site_url("asset/images/file_icons/xls.svg") ?>" alt="xls" height="35px" ></td>
                            <td>excel</td>
                            <td>521 KB</td>
                            <td>ฝ่าย IT</td>
                            <td>IT</td>
