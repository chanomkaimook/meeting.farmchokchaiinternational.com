    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body pb-0">
                <div class="row">
                    <div class="col-lg-6">
                    <div class="card" data-toggle="modal" data-target="#insert-modal-car">
                        <div class="card-body">
                    ...
                    <div class="col-lg-6">
                    <div class="card" data-toggle="modal" data-target="#insert-modal-meeting">
...
<!-- CREATE Modal -car- -->
<div class="modal fade none-border" id="insert-modal-car" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<!-- UPDATE Modal -car- -->
<div class="modal fade none-border" id="update-modal-car" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<!-- READ Modal -car- -->
<div class="modal fade none-border" id="detail-modal-car" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body pb-0">
                <form class="form" data-action="">
                    ...
                    <div class="form-group">
                        <label class="control-label">โดย</label>
                        <select class="form-control form-white" data-placeholder="กรุณาเลือก..." name="detail-staff"
                            disabled>
                            <option value="1">นาย A</option>
                            <option value="2">นาย B</option>
                            <option value="3">นาย C</option>
...
<div class="modal fade none-border" id="insert-modal-meeting" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade none-border" id="update-modal-meeting" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<!-- READ Modal -meeting- -->
<div class="modal fade none-border" id="detail-modal-meeting" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <form class="form" data-action="">
                    ...
                    <div class="form-group mb-3 d-flex flex-row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control datepicker-autoclose" value="2023-10-02"
                                placeholder="yyyy-mm-dd" name="detail-datestart" disabled>
                        </div>
                        <div class="col-md-6">
                            <label class="control-label">ถึง</label>
                            <input type="text" class="form-control datepicker-autoclose" value="2023-10-02"
                                placeholder="yyyy-mm-dd" name="detail-dateend" disabled>
                        </div>
                    </div>
                    <div class="form-group mb-3 d-flex flex-row">
                        <div class="col-md-6">
