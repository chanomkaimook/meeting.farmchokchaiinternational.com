    ...
    function dataShow(eventData = []) {
        ...
        if (!eventData.msg) {
            if (eventData.head) {
                ...
                $.each(eventData.head, function(index, item) {
                    ...
                    <div class="d-flex w-150 justify-content-between">
                        <h5 class="mb-1">การนัดหมายกิจกรรม #${item.CODE}</h5>
                ...
                // head = 0;
                html_head = "<h5>ไม่มีข้อมูลการนัดหมายกิจกรรมที่คุณเป็นประธาน</h5>";
            }
            ...
            if (eventData.visitor) {
                ...
                html_visitor = "<h5>ไม่มีข้อมูลการนัดหมายกิจกรรมที่คุณเป็นผู้เข้าร่วม</h5>";
            }
        } else {
            html = "คุณยังไม่มีข้อมูลการนัดหมายกิจกรรม"
        }
        if (html) {
            ...
            if (head) {
                html_head = `<h5>ข้อมูลการนัดหมายกิจกรรมที่คุณเป็นประธาน</h5>` + html_head
            }

            if (visitor) {
                html_visitor = `<h5>ข้อมูลการนัดหมายกิจกรรมที่คุณเป็นผู้เข้าร่วม</h5>` + html_visitor
            }
